                ...
                <Table className="min-w-[1000px]">
                    <TableHeader>
                        <TableRow className="bg-stone-50 hover:bg-stone-50">
                            <TableHead className="text-xs font-semibold text-stone-400 uppercase tracking-wide text-center">
                                Store
                            </TableHead>
                            <TableHead className="text-xs font-semibold text-stone-400 uppercase tracking-wide text-center">
                                Order ID
                            ...
                            <TableRow key={order.order_id} className="hover:bg-stone-50 transition-colors">
                                ...
                                <TableCell className="text-center align-middle">
                                    <div className="flex flex-col items-center gap-1">
                                        <p className="text-sm font-semibold text-stone-800">{order.store_name}</p>
                                    </div>
                                </TableCell>
                                ...
                                {/* Items - Clickable button to open modal */}
                                <TableCell className="text-center align-middle">
                                    <button
                                ...
                                {/* Status - Clickable with tooltip for cancellation reason */}
                                <TableCell className="text-center align-middle">
                                ...
                                <TableCell className="text-center align-middle">
                                    {activeTab === 'history' && order.status === 'completed' ? (
                                        <button
                                            ...
                                            className="inline-flex items-center gap-1 px-2.5 py-1.5 border border-stone-200 rounded-lg text-xs font-medium text-stone-600 hover:bg-stone-50 transition-colors"
                                        >
