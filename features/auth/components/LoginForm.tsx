...
export const LoginForm: React.FC<LoginFormProps> = ({ className, ...props }) => {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-[#DCE1DE] to-[#9CC5A1] flex items-center justify-center p-4"
      {...props}
    >
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          >
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-[#216869] to-[#49A078] hover:from-[#1a5657] hover:to-[#3d8a66] text-white py-3.5 rounded-xl shadow-lg"
            >
