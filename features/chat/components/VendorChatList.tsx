        ...
        <div>
            ...
            >
                <div className="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p style={{ color: "#93c5fd" }}>Communicate with your customers</p>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                >
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm mb-1" style={{ color: "#92400e" }}>Active Customers</p>
                            <p className="text-4xl font-bold">
                                {values.conversations.filter(c => c.last_message).length}
                            </p>
                        </div>
                ...
                {values.isLoading ? (
                    ...
                    <div className="p-16 text-center">
                        ...
                        <p className="text-gray-400 text-sm">
                            {values.search ? "No conversations match your search." : "Your customers will appear here once they message you."}
                        </p>
                    </div>
                ) : (
